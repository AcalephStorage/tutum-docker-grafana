...
RUN wget http://grafanarel.s3.amazonaws.com/grafana-1.8.1.tar.gz -O grafana.tar.gz && tar zxf grafana.tar.gz && rm grafana.tar.gz && rm -rf app && mv grafana-1.8.1 app
